...
if __name__ == '__main__':
    ...
    scores2,predCorr2,totPred2,prec2,preds2 = accur(classifier1,fisherVectors,labels,True)


    # Impresion de Resultados
    target_names = ['Persona', 'No Persona']
    print("Resultados Clasificador Random Forest")
    print("Predicciones correctas:",predCorr2)
    print("Total predicciones:",totPred2)
    print ("Accuracy RF: ",accuracy_score(labels, preds2))
    c2 = confusion_matrix(labels, preds2)
    print ("Positivos verdaderos:",c2[0,0])
    print ("Falsos negativos:",c2[1,0])
    print ("Falsos positivos:",c2[0,1])
    print ("Negativos verdaderos:",c2[1,1])
