...
def get_args():
    ...
    parser.add_argument('-tc' , "--tcar", help="Directory of txt with characteristics TEST" , default='/Volumes/Datos/DocumentosOSX/Desktop/fisherpython/CHOGT.txt')
    parser.add_argument("-tl" , "--tlab", help="Directory of txt with labels TEST", default = '/Volumes/Datos/DocumentosOSX/Desktop/fisherpython/LHOGT.txt')
    parser.add_argument('-tn' , "--tnimag", help="Number of images TEST" , default=400, type=int)
...
if __name__ == '__main__':
    ...
    arreglofis,arreglol = getfisher(args.tcar,args.tlab,args.tnimag,args.fish,args.dirgmm)

    # Importacion de los clasificadores
    classifier2 = joblib.load(args.dirrf + args.namemodelRF)

    # Evaluacion de clasificadores
    print ('Resultados Random Forest')
    scores2,predCorr2,totPred2,prec2,preds2 = accur(classifier2,arreglofis,arreglol,True)

    # Impresion de Resultados
    target_names = ['No Persona','Persona']
    print("Resultados Clsificador Random Forest")
    print("Predicciones correctas:",predCorr2)
    print("Total predicciones:",totPred2)
    print ("Accuracy RF: ",accuracy_score(arreglol, preds2))
    c1 = confusion_matrix(arreglol, preds2)
    print ("Positivos verdaderos:",c1[1,1])
    print ("Falsos negativos:",c1[1,0])
    print ("Falsos positivos:",c1[0,1])
    print ("Negativos verdaderos:",c1[0,0])
    print(classification_report(arreglol, preds2, target_names=target_names))
