...
if __name__ == '__main__':
    ...
    scores1,predCorr1,totPred1,prec1,preds1 = accur(classifier1,arreglofis,arreglol,True)

    # Impresion de Resultados
    target_names = ['No persona', 'Persona']
    print("Resultados Clsificador SVM")
    print("Predicciones correctas:",predCorr1)
    print("Total predicciones:",totPred1)
    print ("Accuracy SVM: ",accuracy_score(arreglol, preds1))
    c1 = confusion_matrix(arreglol, preds1)
    ...
    print(classification_report(arreglol, preds1, target_names=target_names))
