...
parser.add_argument(
    '--graph',
    default='/Deteccion_Conteo_Personas_Escenas_PUJ-1703/Recursos/ModelosClasificacion/ModelosEntrenados/ANN/',
    type=str,
...
parser.add_argument(
    '--labels',
    default='/Users/user/Desktop/Recursos/ModelosClasificacion//ModelosEntrenados/CNN/Daimler/output_labels.txt',
    type=str,
...
def run_graph(folder, labels, input_layer_name, output_layer_name, num_top_predictions,filename):
  with tf.Session() as sess:
    ...
    file = open("C:/Deteccion_Conteo_Personas_Escenas_PUJ-1703/Recursos/ModelosClasificacion/Prueba/ANN/Predicciones.txt","a")
