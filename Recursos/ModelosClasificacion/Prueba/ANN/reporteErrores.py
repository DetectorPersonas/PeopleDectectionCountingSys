...
def get_args():
    ...
    parser.add_argument('-d1' , "--dir1", help="Directorio con labels teoricos" , default='/Users/user/Desktop/Recursos/ModelosClasificacion/Prueba/ANN/GroundTruth.txt')
    parser.add_argument("-d2" , "--dir2", help="Directorio con labeLs predecidos", default = '/Users/user/Desktop/Recursos/ModelosClasificacion/Prueba/ANN/Predicciones.txt')
...
if __name__ == '__main__':
    ...
    file = open("C:/Deteccion_Conteo_Personas_Escenas_PUJ-1703/Recursos/ModelosClasificacion/Prueba/ANN/Errores.txt","w")
