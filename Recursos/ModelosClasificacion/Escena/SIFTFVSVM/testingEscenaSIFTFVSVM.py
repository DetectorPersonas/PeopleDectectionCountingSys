...
if __name__ == '__main__':
    ...
    if args.visualize == 1:
        plt.show();
    escribirReporte(args.thereshold,args.diferencia,len(verPositivos),len(falPositivos),falNegativos,pre,re,f1,'C:/Deteccion_Conteo_Personas_Escenas_PUJ-1703/Recursos/ModelosClasificacion/Reporte/ReporteSIFTFVSVM.csv',args.visualize)
