...
#define LABELS "/Users/user/Desktop/Recursos/ModelosClasificacion/ModelosEntrenados/CNN/"
...
#define DIR_SCORES "C:/Users/user/Desktop/Recursos/ModelosClasificacion/Escena/CNN/Scores.txt"
...
int main() {
	...
	for (int i = 1; i < numCandidatos + 1; i++){
		filename = "C:/Users/user/Desktop/Recursos/ModelosClasificacion/Escena/CNN/testingCNN.py";
		command = "python ";
		dirimag = " --image ";
		outGraph = " --graph ";
		outLabels = " --labels ";
	...
	filename = "C:/Users/user/Desktop/Recursos/ModelosClasificacion/Escena/CNN/testingEscenaCNN.py";
	command = "python ";
