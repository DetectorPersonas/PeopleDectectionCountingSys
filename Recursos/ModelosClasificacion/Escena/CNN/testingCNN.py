...
parser.add_argument(
    '--graph',
    default='/Users/user/Desktop/Resultados entrenamiento CNN Inception/MIT/output_graph.pb',
    type=str,
    help='Absolute path to graph file (.pb)')
parser.add_argument(
    '--labels',
    default='/Users/user/Desktop/Resultados entrenamiento CNN Inception/MIT/output_labels.txt',
    type=str,
...
def run_graph(image_data, labels, input_layer_name, output_layer_name,
  ...
  with tf.Session() as sess:
    ...
    file1 = open('C:/Deteccion_Conteo_Personas_Escenas_PUJ-1703/Recursos/ModelosClasificacion/Escena/CNN/Predicciones.txt','a')
    file2 = open('C:/Deteccion_Conteo_Personas_Escenas_PUJ-1703/Recursos/ModelosClasificacion/Escena/CNN/Scores.txt','a')
...
def main(argv):
  ...
  print("Tiempo que tarda el proceso: " + str(end-start) + "segundos.")
