...
//Parametros archivo Python entrenamiento RF
#define DIRECCION_FICHERO_CARAC_TRAIN "/Users/user/Desktop/Recursos/ModelosClasificacion/Entrenamiento/HoGRF/CaracteristicasHOGEntrenamiento.txt"
#define DIRECCION_FICHERO_LABELS_TRAIN "/Users/user/Desktop/Recursos/ModelosClasificacion/Entrenamiento/HoGRF/LabelsHOGEntrenamiento.txt"
...
#define DIRECCION_PYTHON "C:/Users/user/Desktop/Recursos/ModelosClasificacion/Entrenamiento/HoGRF/trainingHOG.py"
...
int main(int argc, char** argv)
{
	...
	cout << "INICIO PROCESO EXTRACCION DE CARACTERISTICAS ENTRENAMIENTO..." << endl<<endl;
	...
	CreacionFicherosPython(GradientesImagenes, Etiquetas, "Entrenamiento");
...
void LlamarPython()
{
	...
	string numTrees = " --narb ";

	dirCTr += DIRECCION_FICHERO_CARAC_TRAIN;
	command += dirCTr;
	dirLTr += DIRECCION_FICHERO_LABELS_TRAIN;
	command += dirLTr;
	...
	numTrees += to_string(NUM_ARBOLES);
	command += numTrees;
