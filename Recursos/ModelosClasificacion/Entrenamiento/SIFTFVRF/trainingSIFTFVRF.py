...
def diccionario(caracteristicas,clusters,directorio,version):
    ...
    np.save(directorio + "MeansRF" + args.verdic, means)
    np.save(directorio + "CovsRF" + args.verdic , covs)
    np.save(directorio + "PriorsRF" + args.verdic, priors)
...
if __name__ == '__main__':
    ...
    classifier1 = train2(fisherVectors,labels,args.narb)
    ...
    joblib.dump(classifier1, args.dirrf + args.namemodelRF, compress=5)
